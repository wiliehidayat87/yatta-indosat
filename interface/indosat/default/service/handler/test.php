<?php
class default_service_handler_test extends service_handler_error {
	...
	public function notify($mo_data) {
		...
		$mt_data->subject = strtoupper('MT;PULL;' . $mo_data->channel . ';TEST');
		...
		$mt_data->serviceId = 'mt_outgoing_1000';
		$mt_data->msisdn = $mo_data->msisdn;
		$mt_data->type = 'mtpull';
		$mt_data->mo = serialize ( $mo_data );
