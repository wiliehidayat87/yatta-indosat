<div id="pageheading">
    <h2>Revenue L7 Report</h2>
    {include file=breadcrumb.tpl}
</div>

<div class="actionbar">
    <div class="clearfix" style="font-weight: bold;">
        <a class="btnAdd" id="add"><span>Customize Revenue L7 Report</span></a>
                    ...
                    <div id="optionList" style="clear:both;">
                        ...
                        <ul>
                            {foreach from=$operator item=row}
                                <li><input type="checkbox" class="operatorId" value="{$row.operator_code}" title="{$row.operator}" align="left"> {$row.operator}</li>
                            {/foreach}
                        </ul>
                        {/if}
                    </div>
