...
<div id="dialog-form" title="Edit Ini File">
    <form action="{$base_url}service/add_service/editIniFile" method="post" id="form_edit_inifile"></form>
</div>
<form action ="{$base_url}service/add_service/submit_keyword" method="post" >
            ...
            <div style="padding:10px; color:#000; background-color:#fff">
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="inputtext-1" id="txt-pattern" name="keyword" size="30" maxlength="50" {if $pattern}value="{$pattern}" readonly="readonly"{/if}/>
...
<div id="creator-{$operator_item}" style="display:none">
<br />
<div>
...
<br /><br />
<div id="module-content-{$operator_item}" style="padding-top: 15px"></div>
