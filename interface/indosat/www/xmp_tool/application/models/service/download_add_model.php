...
class Download_add_model extends CI_Model{
    ...
    public function saveNewService($d_name,$d_title,$d_disclaim,$d_desc,$d_type,$sHeader1,$sHeader2, $sHeader3,$sFooter1, $sFooter2, $sFooter3,$sPromo1, $sPromo2, $sPromo3,$sBg1, $sBg2, $sBg3){
        ...
        try {
            ...
            $this->db_wap->insert($this->db_table2, $data);
