...
class Operator extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('report/operator_model');
    ...
    public function index() {
        ...
        $this->smarty->assign('title', 'XMP Internal :: Operator Report');
        $this->smarty->assign('template', 'report/tpl_operator_report_show.tpl');
