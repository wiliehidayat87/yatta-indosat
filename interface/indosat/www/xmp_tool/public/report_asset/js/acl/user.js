...
$(document).ready(function() {
    ...
    $("#user-form").submit(function() {
        ...
        var datapost  = "txt-username=" + $("#txt-username").val();
            ...
            datapost += "&txt-password-compare=" + gbl_password;
            datapost += "&txt-confirmpass-compare=" + gbl_confirmpass;
            datapost += "&txt-group-compare=" + gbl_group;
...
function editUser(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            gbl_password 	= data.password;
			gbl_confirmpass = data.confirmpass;
			gbl_group 		= data.group;
