...
class L7 extends CI_Controller {
    ...
    public function index() {
        ...
        //Chart
        $chart = array();
        array_push($chart, $this->getDailyRevenueReportChartl7());
        array_push($chart, $this->getTopRevenueChartl7());
        array_push($chart, $this->getDailyTrafficReportChartl7());
...
//error_log(print_r($apiResult['data'],1)."sapi\n",3,"/tmp/sapi");
    ...
    public function getDailyRevenueReportChartl7() {
        ...
        $top = 5;
        $group = 'operator';
        $chartData = $this->getDailyRevenueReportl7($daterange, $operatorId, $shortcode, $top, $group);
    ...
    public function getTopRevenueChartl7() {
        $param = array();
        $period = trim($this->input->post('period', true));
        $shortcode = trim($this->input->post('shortcode', true));
        $ajaxCall = $this->input->post('ajaxCall', true);
        ...
        $top = '';
        $group = 'operator';
        $chartData = $this->getTopRevenuel7($daterange, $operatorId, $shortcode, $top, $group);
    ...
    public function getDailyTrafficReportChartl7() {
        $param = array();
        $period = trim($this->input->post('period', true));
        $shortcode = trim($this->input->post('shortcode', true));
...
//        $chartData = $this->getDailyTrafficReport($daterange, $shortcode, $top, $group);
        $result = $this->chart_model->getDailyTrafficServicePercentageChartl7(
    ...
    private function getDailyRevenueReportl7($rangedate, $operatorId, $shortcode, $top, $grouping) {
        ...
        $result = $this->chart_model->getDailyRevenueReportChartl7(API_USERNAME, API_PASSWORD, $startDate, $endDate, $operatorId, $shortcode, $top, $grouping);
    ...
    private function getTopRevenuel7($rangedate, $operatorId, $shortcode, $top, $grouping) {
        // check if rangedate format is double date
        if (stripos($rangedate, ' - ') !== false) {
            // is double date format
            list($startDate, $endDate) = explode(' - ', trim($rangedate));
        ...
        $result = $this->chart_model->getRevenueChartl7(API_USERNAME, API_PASSWORD, $startDate, $endDate, $operatorId, $shortcode, $top, $grouping);
