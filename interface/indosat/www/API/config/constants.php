...
//define('DOMAIN', 'http://localhost:8013/report/');
define('DOMAIN', 'http://localhost:8013/xmp_tool/report/');
...
define('LOG_PATH',        '/app/xmp2012/interface/mcp/www/xmp_tool/application/logs/api/');
define('LOG_LEVEL',       7);
