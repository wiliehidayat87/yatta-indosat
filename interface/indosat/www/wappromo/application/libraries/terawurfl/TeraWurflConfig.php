...
#	public static $DB_HOST = '192.168.1.4';
	/**
	 * Database User
	 * For MongoDB, this may be blank if authentication is not used
	 * @var String
	 */
	public static $DB_USER = 'wapreg';
#	public static $DB_USER = 'sms';
	/**
	 * Database Password
	 * For MongoDB, this may be blank if authentication is not used
	 * @var String
	 */
	public static $DB_PASS = 'wapreg';
#	public static $DB_PASS = 'sms_pwd!!';
	/**
	 * Database Name / Schema Name
	 * @var String
	 */
	public static $DB_SCHEMA = 'wap_tera-wurfl-new';
#	public static $DB_SCHEMA = 'tera-wurfl-new';
	/**
	 * Database Connector (MySQL4, MySQL5, MSSQL2005, MongoDB)
	 * @var String
	 */
	public static $DB_CONNECTOR = "MySQL4";
	/**
