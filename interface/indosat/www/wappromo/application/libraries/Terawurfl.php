...
#	require_once COREPATH.'/library/terawurfl/TeraWurflConfig.php';
	require_once realpath(dirname(__FILE__).'/terawurfl/TeraWurflConfig.php');
}
/**#@+
 * Include required files
 */
require_once realpath(dirname(__FILE__).'/terawurfl/DatabaseConnectors/TeraWurflDatabase.php');
require_once realpath(dirname(__FILE__).'/terawurfl/TeraWurflLoader.php');
require_once realpath(dirname(__FILE__).'/terawurfl/UserAgentFactory.php');
require_once realpath(dirname(__FILE__).'/terawurfl/UserAgentUtils.php');
require_once realpath(dirname(__FILE__).'/terawurfl/WurflConstants.php');
require_once realpath(dirname(__FILE__).'/terawurfl/WurflSupport.php');
require_once realpath(dirname(__FILE__).'/terawurfl/UserAgentMatchers/UserAgentMatcher.php');
/**#@-*/
/**
...
class Terawurfl{
	...
	public function getDeviceCapabilitiesFromAgent($userAgent=null,$httpAccept=null){
		...
		if(TeraWurflConfig::$SIMPLE_DESKTOP_ENGINE_ENABLE){
			require_once realpath(dirname(__FILE__).'/terawurfl/UserAgentMatchers/SimpleDesktopUserAgentMatcher.php');
